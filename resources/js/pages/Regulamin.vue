  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="hero-bg min-h-[400px] flex flex-col justify-center items-center text-center">
      <div class="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <h1 class="text-4xl font-bold text-white sm:text-5xl lg:text-6xl">Regulamin <span class="text-teal">Pobytu</span></h1>
        <p class="mt-4 text-xl text-white max-w-3xl mx-auto bg-white/30 rounded-3xl px-6 py-3">Zasady i warunki pobytu w D.W. Bakster</p>
      </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div class="bg-white shadow rounded-lg p-8">
        ...
        <section class="mb-8">
          ...
          <div class="prose prose-gray max-w-none">
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
              <li>Rezerwacji można dokonać telefonicznie, e-mailowo, poprzez portale rezerwacyjne</li>
              <li>Dokonanie rezerwacji jest równoznaczne z przyjęciem ogólnych zasad rezerwacji i pobytu.</li>
        ...
        <!-- § 3 Informacje ogólne -->
        <section class="mb-8">
          <h2 class="text-2xl font-semibold text-gray-900 mb-4">§ 3 Informacje ogólne</h2>
          <div class="prose prose-gray max-w-none">
            <ul class="list-disc pl-6 space-y-2 text-gray-700">
        ...
        <div class="mt-12 p-6 bg-gray-50 rounded-lg">
          <h3 class="text-lg font-semibold text-gray-900 mb-2">Masz pytania?</h3>
